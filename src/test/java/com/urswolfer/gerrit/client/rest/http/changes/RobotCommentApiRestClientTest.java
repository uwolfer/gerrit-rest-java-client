    ...
    public void testGet() throws Exception {
        GerritRestClient gerritRestClient = new GerritRestClientBuilder()
            .expectGet("/changes/myProject~master~I8473b95934b5732ac55d26311a706c9c2bde9940/" +
                "revisions/" + REVISION_ID + "/robotcomments/" + COMMENT_ID, JsonParser.parseString("{\"robot_id\":\"checkstyle\"}"))
            .get();
        ...
        RobotCommentApiRestClient robotCommentApiRestClient = new RobotCommentApiRestClient(restContext(gerritRestClient), revisionApiRestClient, COMMENT_ID);

        RobotCommentInfo result = robotCommentApiRestClient.get();

        Truth.assertThat(result.robotId).isEqualTo("checkstyle");
