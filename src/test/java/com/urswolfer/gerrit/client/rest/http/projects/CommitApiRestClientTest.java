...
public class CommitApiRestClientTest {
    ...
    public void testGet() throws Exception {
        ...
        GerritRestClient gerritRestClient = new GerritRestClientBuilder()
            .expectGet("/projects/sandbox/commits/49f9e84661d06814c1e9fe3d724f8fffb51b60f4", EMPTY_JSON_OBJECT)
            .get();
    ...
    public void testIncludedIn() throws Exception {
        ...
        String commitSha = "49f9e84661d06814c1e9fe3d724f8fffb51b60f4";
        GerritRestClient gerritRestClient = new GerritRestClientBuilder()
            .expectGet("/projects/sandbox/commits/49f9e84661d06814c1e9fe3d724f8fffb51b60f4/in", EMPTY_JSON_OBJECT)
            .get();
        ProjectsRestClient projectsRestClient = new ProjectsRestClient(gerritRestClient, gerritJson);
