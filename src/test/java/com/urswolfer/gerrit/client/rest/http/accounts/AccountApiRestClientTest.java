...
public class AccountApiRestClientTest {
    ...
    public void testGet() throws Exception {
        GerritRestClient gerritRestClient = new GerritRestClientBuilder()
            .expectGet("/accounts/jdoe", JsonParser.parseString("{\"name\":\"John Doe\"}"))
            .get();
    ...
    public void testDetail() throws Exception {
        GerritRestClient gerritRestClient = new GerritRestClientBuilder()
            .expectGet("/accounts/jdoe/detail", JsonParser.parseString("{\"name\":\"John Doe\"}"))
            .get();
        AccountApiRestClient accountsRestClient = getAccountApiRestClient(gerritRestClient, "jdoe");
    ...
    public void getPreferences() throws Exception {
        ...
        Truth.assertThat(result.changesPerPage).isEqualTo(25);
        EasyMock.verify(gerritRestClient);
    }
    ...
    public void setDiffPreferences() throws Exception {
        GerritRestClient gerritRestClient = new GerritRestClientBuilder()
            .expectPut("/accounts/jdoe/preferences.diff", "{}", JsonParser.parseString("{\"tab_size\":8}"))
            .get();
        AccountApiRestClient accountsRestClient = getAccountApiRestClient(gerritRestClient, "jdoe");
    ...
    public void testGetStars() throws Exception {
        GerritRestClient gerritRestClient = new GerritRestClientBuilder()
            .expectGet("/accounts/jdoe/stars.changes/Iccf90a8284f8371a211db9a2824d0617e95a79f9",
                JsonParser.parseString("[\"label1\",\"label2\"]"))
            .get();
        AccountApiRestClient accountsRestClient = getAccountApiRestClient(gerritRestClient, "jdoe");
    ...
    public void testGetStarredChanges() throws Exception {
        GerritRestClient gerritRestClient = new GerritRestClientBuilder()
            .expectGet("/accounts/jdoe/starred.changes", JsonParser.parseString("[{\"id\":\"foo\"}]"))
            .get();
        AccountApiRestClient accountsRestClient = getAccountApiRestClient(gerritRestClient, "jdoe");
    ...
    public void testListSshKeys() throws Exception {
        GerritRestClient gerritRestClient = new GerritRestClientBuilder()
            .expectGet("/accounts/jdoe/sshkeys", JsonParser.parseString("[{\"ssh_public_key\":\"ssh-rsa AAAA\"}]"))
            .get();
        AccountApiRestClient accountsRestClient = getAccountApiRestClient(gerritRestClient, "jdoe");
        ...
        Truth.assertThat(result.get(0).sshPublicKey).isEqualTo("ssh-rsa AAAA");
        EasyMock.verify(gerritRestClient);
    }
    ...
    public void getExternalIds() throws Exception {
        GerritRestClient gerritRestClient = new GerritRestClientBuilder()
            .expectGet("/accounts/jdoe/external.ids",JsonParser.parseString("[{\"identity\":\"username:jdoe\"}]"))
            .get();
        AccountApiRestClient accountsRestClient = getAccountApiRestClient(gerritRestClient, "jdoe");

        List<AccountExternalIdInfo> result = accountsRestClient.getExternalIds();
        Truth.assertThat(result).hasSize(1);
        Truth.assertThat(result.get(0).identity).isEqualTo("username:jdoe");
        EasyMock.verify(gerritRestClient);
    }
